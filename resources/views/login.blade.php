                ...
                <form method="POST" action="{{ route('authenticate') }}">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••"
                            ...
                            required>
                        <button type="button" onclick="togglePassword()" class="absolute mt-6 inset-y-0 right-3 flex items-center">
                        ...
                        @error('password')
                            <span class="absolute text-red-500 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
