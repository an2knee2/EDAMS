        ...
        <div class="space-y-8">
                ...
                <form class="space-y-4" id="profile-form" method="POST" action="{{ route('student.profile.update') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="school_id" name="school_id" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" value="{{ Auth::guard('student')->user()->school_id }}" disabled>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Program</label>
                            <input type="program_id" name="program_id" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" value="{{ Auth::guard('student')->user()->program_id }}" disabled>
                        </div>
                        <div class="md:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-gray-800 rounded-lg shadow-sm">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <button data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center" onclick="document.getElementById('deactivate-form').submit();">
                                        Yes, deactivate
                                    </button>
                    ...
                    <form id="deactivate-form" method="POST" action="{{ route('student.deactivate') }}" class="hidden">
                        @csrf
                    </form>
                </div>
            </div>
