                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="dropdown-{{ $coordinator->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdown-button-{{ $coordinator->id }}">
                                        <li>
                                            <a class="py-2 px-4 hover:bg-gray-100 flex items-center" onclick="updateStatus('{{ $coordinator->id }}', 'Activated')">
                                        ...
                                        <li>
                                            <a class="py-2 px-4 hover:bg-gray-100 flex items-center" onclick="updateStatus('{{ $coordinator->id }}', 'Disabled')">
