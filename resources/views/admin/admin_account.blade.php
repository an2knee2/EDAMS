                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">admin-account@gmail.com</td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">Activated</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="activation-dropdown-button" data-dropdown-toggle="activation-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                <div id="activation-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="activation-dropdown-button">
                                        <li>
