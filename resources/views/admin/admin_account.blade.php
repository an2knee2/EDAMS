                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="dropdown-{{ $admin->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdown-button-{{ $admin->id }}">
                                        <li>
                                            <a class="block py-2 px-4 hover:bg-gray-100" onclick="updateStatus('{{ $admin->id }}', 'Activated')">Activate</a>
                                        </li>
                                        <li>
                                            <a class="block py-2 px-4 hover:bg-gray-100" onclick="updateStatus('{{ $admin->id }}', 'Disabled')">Disable</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
