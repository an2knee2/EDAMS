                        ...
                        <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <form class="p-4 md:p-5" method="POST" action="{{ route('admin.employee_account.store') }}">
                                        @csrf
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="password" name="password_confirmation" id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Confirm Password" required>
                                        </div>
                                ...
                                @foreach($employees as $index => $employee)
                                    <tr class="border-b">
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="dropdown-button-{{ $employee->id }}" data-dropdown-toggle="dropdown-{{ $employee->id }}" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none" type="button">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                                </svg>
                                            </button>
                                            <div id="dropdown-{{ $employee->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                                <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdown-button-{{ $employee->id }}">
                                                    <li>
                                                        <a class="py-2 px-4 hover:bg-gray-100 flex items-center" onclick="updateStatus('{{ $employee->id }}', 'Activated')">
                                                    ...
                                                    <li>
                                                        <a class="py-2 px-4 hover:bg-gray-100 flex items-center" onclick="updateStatus('{{ $employee->id }}', 'Disabled')">
