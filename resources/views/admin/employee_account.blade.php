        ...
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                @if(isset($employees) && count($employees) > 0)
                        ...
                        <tbody id="employee-table-body">
                            @foreach($employees as $index => $employee)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-700 whitespace-nowrap">{{ $employee->id_number }}</td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="dropdown-{{ $employee->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                            <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdown-button-{{ $employee->id }}">
                                                <li>
                                                    <a class="block py-2 px-4 hover:bg-gray-100" onclick="updateStatus('{{ $employee->id }}', 'Activated')">Activate</a>
                                                </li>
                                                <li>
                                                    <a class="block py-2 px-4 hover:bg-gray-100" onclick="updateStatus('{{ $employee->id }}', 'Disabled')">Disable</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                    ...
                    <p id="no-employees-message" class="text-center font-serif text-gray-600 mt-6 hidden">No employees found.</p>
                @else
                    <p class="text-center font-serif mt-6">No employees found.</p>
                @endif
            </div>
