...
@section('content')
            ...
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <form class="p-4 md:p-5" method="POST"
                                        action="{{ route('admin.employee_account.store') }}">
                                        @csrf
                                        <div>
                                            <label for="id_number" class="block mb-1 text-sm font-medium text-gray-900">ID
                                                Number</label>
                                            <input type="text" name="id_number" id="id_number"
                                                class="mb-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                            <div>
                                                <label for="first_name"
                                                    class="block mb-1 text-sm font-medium text-gray-900">First Name</label>
                                            ...
                                            <div>
                                                <label for="middle_name"
                                                    class="block mb-1 text-sm font-medium text-gray-900">Middle Name</label>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                            <div>
                                                <label for="last_name"
                                                    class="block mb-1 text-sm font-medium text-gray-900">Last Name</label>
                                            ...
                                            <div>
                                                <label for="ext_name"
                                                    class="block mb-1 text-sm font-medium text-gray-900">Extension Name(e.g.
                                                    Jr., Sr.)</label>
                                        ...
                                        <div>
                                            <label for="sex"
                                                class="block mt-2 mb-1 text-sm font-medium text-gray-900">Sex</label>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                            <div>
                                                <label for="contact_number"
                                                    class="block mb-1 text-sm font-medium text-gray-900">Contact
                                                    Number</label>
                                            ...
                                            <div>
                                                <label for="email"
                                                    class="block mb-1 text-sm font-medium text-gray-900">Email
                                                    Address</label>
                                        ...
                                        <div>
                                            <label for="password"
                                                class="block mt-2 mb-1 text-sm font-medium text-gray-900">Password</label>
                                        ...
                                        <div>
                                            <label for="confirm_password"
                                                class="block mt-2 mb-1 text-sm font-medium text-gray-900">Confirm
                                                Password</label>
                                        ...
                                        <div class="flex justify-end mt-6">
                                            <button type="submit"
                                                class="w-full bg-blue-700 hover:bg-blue-800 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-4 focus:outline-none focus:ring-blue-300 max-w-md">
                                                <svg class="me-1 -ms-1 w-5 h-5 inline" fill="currentColor"
                                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd"
                            ...
                            <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow">
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    <li class="flex items-center">
                                        <input id="activated" type="checkbox" value="Activated"
                                            class="filter-checkbox w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                        <label for="activated"
                                            class="ml-2 text-sm font-medium text-gray-900">Activated</label>
                                    </li>
                                    <li class="flex items-center">
                                        <input id="disabled" type="checkbox" value="Disabled"
                                            class="filter-checkbox w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                        <label for="disabled"
                                            class="ml-2 text-sm font-medium text-gray-900">Disabled</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="overflow-x-auto">
                    @if(isset($employees) && count($employees) > 0)
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-900 uppercase bg-gray-200">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Employee's Name</th>
                            ...
                            <tbody id="employee-table-body">
                                @foreach($employees as $index => $employee)
                                    <tr class="border-b">
                                        ...
                                        <td class="px-4 py-3 font-medium text-gray-700 whitespace-nowrap">{{ $employee->id_number }}
                                        </td>
                                        <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                            {{ $employee->first_name }}
                                            @if($employee->middle_name)
                                            {{ strtoupper(substr($employee->middle_name, 0, 1)) }}.@endif 
                                            {{ $employee->last_name }}
                                            @if($employee->ext_name) , {{ $employee->ext_name }}@endif
                                        </td>
                                        <td class="px-4 py-3 text-gray-700 whitespace-nowrap">{{ $employee->sex }}</td>
                                        <td class="px-4 py-3 text-gray-700 whitespace-nowrap">{{ $employee->email }}</td>
                                        <td class="px-4 py-3 text-gray-700 whitespace-nowrap status-column-{{ $employee->id }}">
                                            <div class="flex items-center">
                                                <span
                                                    class="h-3 w-3 rounded-full mr-2 
                                                                        {{ $employee->status == 'Activated' ? 'bg-green-500' : 'bg-red-500' }}">
                                                </span>
                                                <span class="status-text">{{ $employee->status }}</span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="dropdown-button-{{ $employee->id }}"
                                            ...
                                            <div id="dropdown-{{ $employee->id }}"
                                                ...
                                                <ul class="py-1 text-sm text-gray-700"
                                                    aria-labelledby="dropdown-button-{{ $employee->id }}">
                                                    <li>
                                                        <a class="block py-2 px-4 hover:bg-gray-100"
                                                            onclick="updateStatus('{{ $employee->id }}', 'Activated')">Activate</a>
                                                    </li>
                                                    <li>
                                                        <a class="block py-2 px-4 hover:bg-gray-100"
                                                            onclick="updateStatus('{{ $employee->id }}', 'Disabled')">Disable</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                        ...
                        <div id="no-employees-message" class="text-center font-serif text-gray-600 mt-6 hidden">
                        ...
                        @else(isset($employees) && count($employees) == 0)
                            <div class="text-center font-serif text-gray-600 mt-6">
                                ...
                                No employee accounts added yet.
                            </div>
                    @endif
                </div>
    ...
    <script>
        ...
        function updateStatus(employeeId, status) {
            fetch("{{ url('/admin/employee-accounts') }}/" + employeeId + "/status", {
                method: "PATCH",
                headers: {
                ...
                .then(data => {
                    if (data.success) {
                        document.querySelector('.status-column-' + employeeId + ' .status-text').innerText = data.new_status;
                        let indicator = document.querySelector('.status-column-' + employeeId + ' span');
    ...
    <script>
        ...
        function filterTable(searchTerm) {
            ...
            document.querySelectorAll('#employee-table-body tr').forEach(row => {
                const employeeName = row.querySelector('td:nth-child(3)').innerText.toLowerCase();
            ...
            document.getElementById('no-employees-message').style.display = hasVisibleRows ? 'none' : 'block';
        }
    </script>
