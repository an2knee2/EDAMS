    ...
    <div class="mx-auto max-w-screen-xl relative">
        ...
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="w-full md:w-1/2">
                    <form class="block items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 flex w-full pl-10 p-2" placeholder="Search School" required="">
                        </div>
                    </form>
                </div>
            ...
            <div class="overflow-x-auto">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="editation-dropdown-{{ $school->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="editation-dropdown-button-{{ $school->id }}">
                                            <li>
                                                <a href="#" data-modal-target="edit-school-modal-{{ $school->id }}" data-modal-toggle="edit-school-modal-{{ $school->id }}" class=" py-2 px-4 hover:bg-gray-100 flex items-center">
                                            ...
                                            <li>
                                                <a href="#" data-modal-target="delete-school-modal-{{ $school->id }}" data-modal-toggle="delete-school-modal-{{ $school->id }}" class="py-2 px-4 hover:bg-gray-100 flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#434343" class="mr-2">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        <div class="p-4 md:p-5 text-center bg-gray-800 rounded-lg">
                                            ...
                                            <form method="POST" action="{{ route('admin.school.destroy', $school->id) }}">
                                                ...
                                                <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700" data-modal-hide="delete-school-modal-{{ $school->id }}">
                                                    No, cancel
                                                </button>
                                            </form>
                                        </div>
                ...
                <div id="no-schools-message" class="text-center font-serif text-gray-600 mt-6 hidden">
                ...
                @else(isset($schools) && count($schools) == 0)
