                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-900 uppercase bg-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Abbrevation</th>
                    ...
                    <tbody>
                        ...
                        <th class="px-4 py-3 font-medium text-gray-700 whitespace-nowrap">School of Technology and Computer Studies</th>
                        <th class="px-4 py-3 font-medium text-gray-700 whitespace-nowrap">STCS</th>
