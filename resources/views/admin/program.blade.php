                        ...
                        <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow">
                            ...
                            <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                <li class="flex items-center">
                                    ...
                                    <label for="apple" class="ml-2 text-sm font-medium text-gray-900">STCS</label>
                                </li>
                                <li class="flex items-center">
                                    ...
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">SOE</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">SCJE</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">SAS</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">SNHS</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">SME
                                <li class="flex items-center">
                                    <input id="fitbit" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500">
                                    <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">STEd</label>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">School of Technology and Computer Studies</td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">Bachelor of Science in Computer Science</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="editation-dropdown-button" data-dropdown-toggle="editation-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                <div id="editation-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="editation-dropdown-button">
                                        <li>
