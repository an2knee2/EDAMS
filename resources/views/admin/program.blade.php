    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="editation-dropdown-{{ $program->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="editation-dropdown-button-{{ $program->id }}">
                                        <li>
                                            <a href="#" data-modal-target="edit-program-modal-{{ $program->id }}" data-modal-toggle="edit-program-modal-{{ $program->id }}" class="block py-2 px-4 hover:bg-gray-100">Edit</a>
                                        </li>
                                        <li>
                                            <a href="#" data-modal-target="delete-program-modal-{{ $program->id }}" data-modal-toggle="delete-program-modal-{{ $program->id }}" class="block py-2 px-4 hover:bg-gray-100">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    <div class="p-4 md:p-5 text-center bg-gray-800 rounded-lg">
                                        ...
                                        <form method="POST" action="{{ route('admin.program.destroy', $program->id) }}">
                                            ...
                                            <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100" data-modal-hide="delete-program-modal-{{ $program->id }}">
                                                No, cancel
                                            </button>
                                        </form>
                                    </div>
                ...
                <div id="no-programs-message" class="text-center font-serif text-gray-600 mt-6 hidden">No Program Found</div>
            </div>
